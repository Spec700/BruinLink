...
values
  (
    ...
    'Thursdays, 6:30 PM',
    '{"name": "Boelter Hall", "city": "Los Angeles", "state": "CA", "country": "USA"}'::jsonb,
    48,
    'fresh',
    'visible',
  ...
  (
    ...
    'Mondays, 7:00 PM',
    '{"name": "Engineering VI", "city": "Los Angeles", "state": "CA", "country": "USA"}'::jsonb,
    36,
    'steady',
    'visible',
  ...
  (
    ...
    'Fridays, 5:00 PM',
    '{"name": "Perloff Hall", "city": "Los Angeles", "state": "CA", "country": "USA"}'::jsonb,
    29,
    'needs update',
    'visible',
  ...
  (
    ...
    'Wednesdays, 6:00 PM',
    '{"name": "YRL Collaboration Room", "city": "Los Angeles", "state": "CA", "country": "USA"}'::jsonb,
    72,
    'fresh',
    'visible',
  ...
  (
    ...
    'Tuesdays, 7:30 PM',
    '{"name": "Mathematical Sciences", "city": "Los Angeles", "state": "CA", "country": "USA"}'::jsonb,
    64,
    'steady',
    'visible',
  ...
  (
    ...
    'Sundays, 3:00 PM',
    '{"name": "Student Activities Center", "city": "Los Angeles", "state": "CA", "country": "USA"}'::jsonb,
    55,
    'fresh',
    'visible',
  ...
  (
    ...
    'Thursdays, 7:00 PM',
    '{"name": "Ackerman Union", "city": "Los Angeles", "state": "CA", "country": "USA"}'::jsonb,
    41,
    'steady',
    'visible',
  ...
  (
    ...
    'Tuesdays, 6:30 PM',
    '{"name": "Bunche Hall", "city": "Los Angeles", "state": "CA", "country": "USA"}'::jsonb,
    38,
    'needs update',
    'visible',
  ...
  (
    ...
    'Saturdays, 10:00 AM',
    '{"name": "Anderson Courtyard", "city": "Los Angeles", "state": "CA", "country": "USA"}'::jsonb,
    52,
    'fresh',
    'visible',
  ...
  (
    ...
    'Fridays, 7:00 PM',
    '{"name": "De Neve Commons", "city": "Los Angeles", "state": "CA", "country": "USA"}'::jsonb,
    67,
    'steady',
    'visible',
  ...
  (
    ...
    'Wednesdays, 8:00 PM',
    '{"name": "Kerckhoff Hall", "city": "Los Angeles", "state": "CA", "country": "USA"}'::jsonb,
    34,
    'fresh',
    'visible',
  ...
  (
    ...
    'Mondays, 5:00 PM',
    '{"name": "Bruin Walk", "city": "Los Angeles", "state": "CA", "country": "USA"}'::jsonb,
    73,
    'steady',
    'visible',
  ...
  (
    ...
    'Saturdays, 8:00 PM',
    '{"name": "Rieber Hall", "city": "Los Angeles", "state": "CA", "country": "USA"}'::jsonb,
    44,
    'fresh',
    'visible',
  ...
  (
    ...
    'Sundays, 9:00 AM',
    '{"name": "Westwood Plaza", "city": "Los Angeles", "state": "CA", "country": "USA"}'::jsonb,
    58,
    'steady',
    'visible',
  ...
  (
    ...
    'Thursdays, 5:30 PM',
    '{"name": "Powell Library", "city": "Los Angeles", "state": "CA", "country": "USA"}'::jsonb,
    46,
    'needs update',
    'visible',
